		     ...
		     unsigned int stream_id)
{
	...
	if (!TFW_MSG_H2(req)) {
		 ...
		 * response.
		 *
		 * If original message was in chunked encoding, it was removed
		 * and chunked trailer headers are stored with arbitrary headers.
		 * Add content-length header for correct message framing.
		 */
